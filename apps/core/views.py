...
def about_page(request):
    ...
    features = [
        ...
        {"titre": "Laboratoire", "desc": "59 examens tarifés, répartition 20/60/40 figée", "icon": "flask-conical", "svg": drop()},
        ...
        {"titre": "Rapports", "desc": "Journalier / mensuel / annuel — WhatsApp, PDF, Excel", "icon": "file-text", "svg": bars()},
